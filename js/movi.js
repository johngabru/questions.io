...
const perguntas = [
  ...
  { texto:'O que a Dreia disse antes de falar “quero que coloque cogumelo na minha boca”?', op:['A) Fode com força no meu cu, minha buceta','B)  Não, eu quero muito que vc me coma mesmo','C) Minha buceta'], correta:'a' },
  { texto:'Quem foi que disse “não posso, eu tenho família”?', op:['A) Rolezinho','B) Azulinho ','C) Theus'], correta:'c' },
